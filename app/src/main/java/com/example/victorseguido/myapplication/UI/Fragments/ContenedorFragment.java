...
import com.example.victorseguido.myapplication.UI.Adapter.SeccionesAdapter;
...
public class ContenedorFragment extends Fragment {
    ...
    private void llenarViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new highTrendFragment(),"HIGHTREND");
        adapter.addFragment(new lowTrendFragment(),"LOWTREND");
